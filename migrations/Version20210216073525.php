 ...
 */
final class Version20210216073525 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bailleur_bailleur (bailleur_source INT NOT NULL, bailleur_target INT NOT NULL, INDEX IDX_8078C37E8A13F4C7 (bailleur_source), INDEX IDX_8078C37E93F6A448 (bailleur_target), PRIMARY KEY(bailleur_source, bailleur_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
